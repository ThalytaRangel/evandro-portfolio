    ...
    <section id="about" className="flex font-display flex-col items-center justify-between gap-10 lg:max-h-svh px-6 py-16 lg:flex-row lg:gap-0 lg:px-24 lg:py-28">
      <div id="about-me" className="p-12 text-start flex flex-col lg:h-[744px]">
        <div className="flex gap-2 max-w-full items-center">
          <h2 className="text-3xl font-normal text-light-blue whitespace-nowrap"><span className="text-secondary pe-0.5">#</span>Sobre mim</h2> 
        ...
        <div className="text-xl font-normal text-light-blue mt-8">
          <p><span className="me-5">1</span>/**</p>
          <p><span className="me-5">2</span>* I have 5 years of еxperience in web</p>
          <p><span className="me-5">3</span>* development lorem ipsum dolor sit amet,</p>
          <p><span className="me-5">4</span>* consectetur adipiscing elit, sed do eiusmod</p>
          <p><span className="me-5">5</span>* tempor incididunt ut labore et dolore</p>
          <p><span className="me-5">6</span>* magna aliqua. Ut enim ad minim veniam,</p>
          <p><span className="me-5">7</span>* quis nostrud exercitation ullamco laboris</p>
        </div>      
      </div>
