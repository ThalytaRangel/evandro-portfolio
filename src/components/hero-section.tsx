...
export function Hero() {  
  ...
  return ( 
    <section id="home" className="flex font-display flex-col items-center justify-between gap-10  px-6 py-16 lg:flex-row lg:gap-0 lg:px-28 lg:py-32">
      ...
      <p className="text-2xl font-normal text-light-blue mt-4">Olá pessoal, sou o</p>
      <h2 className="text-5xl font-extrabold">Evandro Damaso</h2>
        <p className="text-2xl text-secondary mt-4">&gt; Desenvolvedor Full Stack</p>
        <p className="mt-6 text-2xl text-light-blue">He crafts responsive websites where technologies meet creativity</p>
        <p className="mt-4 text-xl text-comments">// you can also see it on my Github page</p>
        <p className="mt-6 text-xl text-light-blue"><span className="text-secondary">const</span> <span className="text-details">githubLink</span> = <a className="text-tomato hover:text-tomato-bright" href="/">“https://github.com/example/url”</a></p>
